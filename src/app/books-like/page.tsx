...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: "Books like Servitude et grandeur militaires include Chatterton by Vigny, The Charterhouse of Parma by Stendhal, War and Peace by Tolstoy, All Quiet on the Western Front by Remarque, The Red Badge of Courage by Stephen Crane, The Things They Carried by Tim O'Brien, In Parenthesis by David Jones, and Vigny's poetry. Our full guide covers 8 picks for readers of Vigny's stoic military novellas." },
    },
    {
      '@type': 'Question',
