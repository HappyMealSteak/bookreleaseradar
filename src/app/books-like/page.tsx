...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "books like François le Champi George Sand foundling pastoral Berry Proust",
    "George Sand reading order François Champi pastoral novels Proust connection",
    "French Romantic pastoral foundling novel Sand Berry transformation love",
    'books like La Petite Fadette George Sand pastoral Berry twins outsider girl',
    'George Sand reading order pastoral Petite Fadette Champi Mare Diable trilogy',
    'French Romantic pastoral outsider community integration novel Sand 1849',
    ...
    'books like Lélia George Sand philosophical prose poem romantic despair',
    'George Sand early novels Lélia Indiana reading order feminist',
    'French Romantic philosophical fiction exceptional woman Sand 1833',
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      '@type': 'Question',
      name: 'What should I read if I liked François le Champi by George Sand?',
      acceptedAnswer: { '@type': 'Answer', text: "Books like François le Champi include La Mare au Diable and La Petite Fadette (the Berry pastoral trilogy, also by Sand), In Search of Lost Time by Proust (which contains the famous bedtime reading scene), Under the Greenwood Tree by Hardy, Mauprat by Sand, Silas Marner by George Eliot, Oliver Twist by Dickens, and Père Goriot by Balzac. Our full guide covers 8 picks for readers of Sand's foundling pastoral novel." },
    },
    {
      '@type': 'Question',
      name: 'What should I read if I liked La Petite Fadette by George Sand?',
      acceptedAnswer: { '@type': 'Answer', text: "Books like La Petite Fadette include La Mare au Diable and François le Champi (the Berry pastoral trilogy, also by Sand), Mauprat by Sand, Under the Greenwood Tree by Hardy, The Winter's Tale by Shakespeare, As You Like It by Shakespeare, Consuelo by Sand, and Tess of the d'Urbervilles by Hardy. Our full guide covers 8 picks for readers of Sand's pastoral novel about twins and the outsider girl." },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      '@type': 'Question',
      name: 'What should I read if I liked Lélia by George Sand?',
      acceptedAnswer: { '@type': 'Answer', text: "Books like Lélia include Indiana and Valentine (also by Sand), René by Chateaubriand, Adolphe by Benjamin Constant, Atala by Chateaubriand, The Mill on the Floss by George Eliot, Camille by Dumas fils, La Nouvelle Héloïse by Rousseau, and The Second Sex by Beauvoir (non-fiction). Our full guide covers 8 picks for readers of Sand's philosophical prose poem of romantic despair." },
    },
    {
      '@type': 'Question',
